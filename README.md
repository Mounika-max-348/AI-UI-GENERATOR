...
[![Live Demo](https://img.shields.io/badge/Live-Demo-brightgreen?style=for-the-badge)](https://ai-ui-generator-mouni.netlify.app/)

### 🌐 [**Try Live Demo →**](https://ai-ui-generator-mouni.netlify.app/)

### 🎯 Quick Links
- 🚀 [**Live Application**](https://ai-ui-generator-mouni.netlify.app/) - Try it now!
- 📂 [**GitHub Repository**](https://github.com/Mounika-max-348/AI-UI-GENERATOR) - View source code
- 📖 [**Documentation**](#-installation) - Setup guide
- 🐛 [**Report Issues**](https://github.com/Mounika-max-348/AI-UI-GENERATOR/issues) - Found a bug?
...
**Live Application:** [https://ai-ui-generator-mouni.netlify.app/](https://ai-ui-generator-mouni.netlify.app/)

Experience the power of AI-driven UI generation in action! Simply enter natural language prompts and watch as the AI creates beautiful React components instantly.

### 🎯 Quick Test Prompts:
- `create navbar with logo and menu`
- `add card with 3 buttons`
...
- ✅ Generate multiple components with one prompt
- ✅ View generated JSX code instantly
- ✅ See AI explanations of the layout
...
```bash
git clone https://github.com/Mounika-max-348/AI-UI-GENERATOR.git
cd AI-UI-GENERATOR
```
...
**Frontend:** [https://ai-ui-generator-mouni.netlify.app/](https://ai-ui-generator-mouni.netlify.app/)
...
### Frontend Deployment (Netlify - Current Deployment)

The app is currently deployed on Netlify. To deploy your own version:
...
Currently deployed at: `ai-ui-generator-mouni.netlify.app`
...
- GitHub: [@Mounika-max-348](https://github.com/Mounika-max-348)
- Repository: [AI-UI-GENERATOR](https://github.com/Mounika-max-348/AI-UI-GENERATOR)
- Live Demo: [ai-ui-generator-mouni.netlify.app](https://ai-ui-generator-mouni.netlify.app/)
...
![GitHub stars](https://img.shields.io/github/stars/Mounika-max-348/AI-UI-GENERATOR?style=social)
![GitHub forks](https://img.shields.io/github/forks/Mounika-max-348/AI-UI-GENERATOR?style=social)
![GitHub issues](https://img.shields.io/github/issues/Mounika-max-348/AI-UI-GENERATOR)
![GitHub pull requests](https://img.shields.io/github/issues-pr/Mounika-max-348/AI-UI-GENERATOR)
